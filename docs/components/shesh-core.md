...
GPL-3.0-or-later — see [LICENSE](https://github.com/gaganjainse/shesh-core/blob/main/LICENSE).
...
CI green. Security: [SECURITY.md](https://github.com/gaganjainse/shesh-core/blob/main/SECURITY.md). Compiled reading:
