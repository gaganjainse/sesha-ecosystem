...
vulnerability reporting: [SECURITY.md](https://github.com/gaganjainse/shesh-memory/blob/main/SECURITY.md).
...
GPL-3.0-or-later — see [LICENSE](https://github.com/gaganjainse/shesh-memory/blob/main/LICENSE).
