#!/usr/bin/env python3
"""Resolve the Shesh component manifest into a lockfile.

Validates schema, enforces GPL-3 body license compatibility, and writes
``shesh.lock`` (deterministic, sorted). This is the first quality gate: a
...
def main() -> int:
    ...
    ap.add_argument("--out", default="shesh.lock", type=Path)
