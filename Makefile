...
check: lint test sync-check journal-check steer-check guard-check
...
guard-check:  ## fail if any recorded failure has returned
	python3 ../shesh-workspace/tools/guard.py --check
